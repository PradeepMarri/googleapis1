...
func Grafeas_createnote2Handler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGrafeas_createnote2Tool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_parent_1_notes",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Grafeas_createnote2Handler(cfg),
	}
}
