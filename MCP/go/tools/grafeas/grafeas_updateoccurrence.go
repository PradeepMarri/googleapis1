...
func Grafeas_updateoccurrenceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGrafeas_updateoccurrenceTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    Grafeas_updateoccurrenceHandler(cfg),
	}
}
