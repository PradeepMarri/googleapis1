...
func Grafeas_createoccurrence2Handler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/%s/occurrences", cfg.BaseURL, parent_1)
...
func CreateGrafeas_createoccurrence2Tool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_parent_1_occurrences",
		mcp.WithDescription("Creates a new occurrence."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Grafeas_createoccurrence2Handler(cfg),
	}
}
