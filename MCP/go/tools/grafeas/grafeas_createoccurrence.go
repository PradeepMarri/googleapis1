...
func Grafeas_createoccurrenceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v1/%s/occurrences", cfg.BaseURL, parent)
...
func CreateGrafeas_createoccurrenceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_parent_occurrences",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Grafeas_createoccurrenceHandler(cfg),
	}
}
