# grafeas.proto MCP Server

This MCP (Model Content Protocol) server provides access to grafeas.proto API functionality through HTTP, HTTPS, and STDIO transport modes.
